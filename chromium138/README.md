...
* `llvm (Release+Asserts-138.tar.bz2): `  点击[下载](http://ftp.loongnix.cn/browser/build/toolchain/Release+Asserts-138.tar.bz2)
...
* `适配patch (0001-la64-cross-CH138-Add-loongarch-build-support-for-old-new-w.patch): `  点击[下载](./0001-la64-cross-CH138-Add-loongarch-build-support-for-old-new-w.patch)

`0001-la64-cross-CH138-Add-loongarch-build-support-for-old-new-w.patch`文件打入源码：

```shell
$ patch -Np1 -i 0001-la64-cross-CH138-Add-loongarch-build-support-for-old-new-w.patch
```
...
上述patch基于138.0.7204.17构建生成，已包含ffmpeg配置文件的生成，patch打入成功则忽略ffmpeg配置。
...
至此，Chromium138构建配置已完成，您可以继续完成后面的[交叉构建](../#三构建配置)
